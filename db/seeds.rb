...
user_Ivan = User.create!( username: "Ivan", password: 453213 )
user_Vano = User.create!( username: "Vano", password: 983532 )
user_Jack = User.create!( username: "Jack", password: 214567 )
...
test_javascript = Test.create!(title: "JavaScript begin", level: 0, category_id: category_javascript.id, author_id: user_Ivan.id )
...
answer_qdb = Answer.create!(title: "Yes", correct: true, question_id: question_djangobegin.id)
answer_qdb = Answer.create!(title: "No", correct: false, question_id: question_djangobegin.id)
answer_qrb = Answer.create!(title: "Yes", correct: true, question_id: question_railsbegin.id)
